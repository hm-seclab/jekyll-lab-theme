...
const PRE_BUILD_STYLESHEET = "./src/site.css";
...
task("processStyles", () => {
  ...
  if (isDevelopmentBuild) {
    console.log("Development build detected. Skipping CSS minification.");
  } else {
    console.log("Production build detected. Minifying CSS...");
  }
